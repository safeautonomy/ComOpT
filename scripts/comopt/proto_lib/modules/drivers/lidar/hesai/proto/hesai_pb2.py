...
# source: modules/drivers/lidar/hesai/proto/hesai.proto
...
HesaiScanPacket = _reflection.GeneratedProtocolMessageType('HesaiScanPacket', (_message.Message,), dict(
  ...
  __module__ = 'modules.drivers.lidar.hesai.proto.hesai_pb2'
