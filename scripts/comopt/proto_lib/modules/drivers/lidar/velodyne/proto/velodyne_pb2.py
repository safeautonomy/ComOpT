...
# source: modules/drivers/lidar/velodyne/proto/velodyne.proto
...
VelodynePacket = _reflection.GeneratedProtocolMessageType('VelodynePacket', (_message.Message,), dict(
  ...
  __module__ = 'modules.drivers.lidar.velodyne.proto.velodyne_pb2'
